...
--------------------
This version of the plug-in works with Moodle 2.2 or newer and supports single sign-on. Users running Moodle v1.8-1.9
...
This plugin will work with Moodle 2.2 or newer. It is developed as a Moodle plugin/block.
