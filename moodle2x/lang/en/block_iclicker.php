...
$string['reg.registered.clickerId.remote.invalid'] = 'This i>clicker Remote ID ({$a}) is not valid. Please check your entry and try again';
...
// GO FAQS
$string['reg.remote.faq5.question'] = 'Where do I find my i>clicker GO ID?'; // image
