...
$plugin->version    = 2013012500;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.3 (Build: 2013012500)'; // visible version - must match iclicker_service constant
