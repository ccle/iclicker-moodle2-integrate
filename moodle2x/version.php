...
$plugin->version    = 2013041500;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.4 (Build: 2013041500)'; // visible version - must match iclicker_service constant
