...
$plugin->version    = 2013051500;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.5 (Build: 2013051500)'; // visible version - must match iclicker_service constant
