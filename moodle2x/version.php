...
$plugin->version    = 2012082100;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.1 (Build: 2012081600)'; // visible version - must match iclicker_service constant
