...
$plugin->version = 2014020900; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '1.8 (Build: 2014020900)'; // visible version - must match iclicker_service constant
