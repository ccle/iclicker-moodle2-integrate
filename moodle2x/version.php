...
$plugin->version    = 2012102100;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.2 (Build: 2012102100)'; // visible version - must match iclicker_service constant
