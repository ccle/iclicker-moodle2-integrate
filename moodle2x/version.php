...
$plugin->version    = 2012110400;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.2 (Build: 2012110400)'; // visible version - must match iclicker_service constant
