...
$plugin->version    = 2013072900;        // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release    = '1.6 (Build: 2013072900)'; // visible version - must match iclicker_service constant
