...
$plugin->version = 2014021600; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '1.8 (Build: 2014021600)'; // visible version - must match iclicker_service constant
