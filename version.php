...
$plugin->version = 2015062100; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '1.8.2 (Build: 2015062100)'; // visible version - must match iclicker_service constant
