...
$plugin->version = 2016072900; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '2.1 (Build: 2016072900)'; // visible version - must match iclicker_service constant
