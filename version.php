...
$plugin->version = 2015070400; // The current plugin version (Date: YYYYMMDDXX) - must match iclicker_service constant
...
$plugin->release = '1.8.3 (Build: 2015070400)'; // visible version - must match iclicker_service constant
