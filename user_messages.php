...
<div class="information user_messages alert_messages informationbox">
    <ul class="messages_list">
        ...
        <li class="user_message info_message alert alert-info"><?php echo $message ?></li>
        <?php } ?>
    </ul>
</div>
<?php } ?>
...
<div class="alertMessage user_messages info_messages errorbox">
    <ul class="messages_list">
        ...
        <li class="user_message alert_message alert alert-error"><?php echo $message ?></li>
        <?php } ?>
    </ul>
</div>
<?php } ?>
...
<?php
    ...
    if (basename($_SERVER['PHP_SELF']) != 'registration.php') {
        ...
        echo html_writer::tag('span', 'Download UCLA version of the i>clicker 7.13.0 software (');
        ...
        foreach ($packages as $package => $description) {
            $packages[$package] = html_writer::link(
                    new moodle_url(sprintf('/blocks/iclicker/files/iclicker-7.13.0-%s.zip',
                            $package)), $description);
        }
