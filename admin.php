...
<div class="iclicker">
        ...
        <div class="main_content_header">
            ...
            <div class="search_filters" style="float:right;">
                <form method="get" action="<?php echo iclicker_service::block_url('admin.php') ?>" style="margin:0;">
                    ...
                    <input name="search" value="<?php echo $search ?>" class="clicker_id_filter" type="text" size="12"
                           maxlength="12"/>
                    ...
                    <input type="submit" class="small"
                           value="<?php echo iclicker_service::msg('admin.search.search') ?>"
                           alt="<?php echo iclicker_service::msg('admin.search.search') ?>"/>
                    <input name="purge" id="purgeFormSubmit" type="submit" class="small"
                           value="<?php echo iclicker_service::msg('admin.search.purge') ?>"
                           alt="<?php echo iclicker_service::msg('admin.search.purge') ?>"/>
                </form>
                <form method="get" style="margin:0;">
                    <input type="submit" class="small" value="<?php echo iclicker_service::msg('admin.search.reset') ?>"
                           alt="<?php echo iclicker_service::msg('admin.search.reset') ?>"/>
                </form>
            </div>
        </div>
                ...
                <tr class="registration_row data_row style1 <?php echo $registration->activated ? '' : 'disabled' ?>">
                    ...
                    <td class="controls" align="center">
                        <form method="post">
                            ...
                            <?php if ($registration->activated) { ?>
                                <input type="button" class="small"
                                       value="<?php echo iclicker_service::msg('app.activate') ?>" disabled="disabled"/>
                                <input type="submit" class="small"
                                       value="<?php echo iclicker_service::msg('app.disable') ?>"
                                       alt="<?php echo iclicker_service::msg('reg.disable.submit.alt') ?>"/>
                                <input type="hidden" name="activate" value="0"/>
                            <?php } else { ?>
                                <input type="submit" class="small"
                                       value="<?php echo iclicker_service::msg('app.activate') ?>"
                                       alt="<?php echo iclicker_service::msg('reg.reactivate.submit.alt') ?>"/>
                                <input type="button" class="small"
                                       value="<?php echo iclicker_service::msg('app.disable') ?>" disabled="disabled"/>
                        ...
                        <form method="post">
                            ...
                            <input type="submit" class="small" value="<?php echo iclicker_service::msg('app.remove') ?>"
                                   alt="<?php echo iclicker_service::msg('admin.remove.submit.alt') ?>"/>
                        </form>
                    </td>
                </tr>
            <?php } ?>
    ...
    <div class="download_link"><a
                href="<?php echo iclicker_service::block_url('adminCSV.php') ?>"><?php echo iclicker_service::msg('admin.csv.download') ?></a>
    </div>
            ...
            <ul class="tight admin_config_list">
                <?php if ($sso_enabled) { ?>
                    <li class="admin_config_list_item">
                        ...
                        <?php echo iclicker_service::msg('admin.config.ssosharedkey') ?>: <span
                                class="sso_shared_key"><?php echo $sso_shared_key; ?></span>
                    </li>
                <?php } ?>
                <li class="admin_config_list_item">
    ...
    <div class="iclicker_version">Version <?php echo iclicker_service::VERSION ?>
        (<?php echo iclicker_service::BLOCK_VERSION ?>)
    </div>
